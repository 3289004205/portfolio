...
export default function ContactPage() {
  ...
  return (
    <motion.main
      ...
      className="mx-auto flex min-h-screen max-w-[700px] flex-col justify-center bg-bg px-6 py-24 md:px-10"
    >
      <button
        onClick={() => navigate('/')}
      ...
      <a
        href="mailto:hello@xiulongyang.com"
      ...
      >
        hello@xiulongyang.com <span className="ml-2">↗</span>
      </a>
